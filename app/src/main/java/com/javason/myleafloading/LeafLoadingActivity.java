...
public class LeafLoadingActivity extends Activity implements SeekBar.OnSeekBarChangeListener,
  ...
  Handler mHandler = new Handler() {
            ...
            switch (msg.what) {
                case REFRESH_PROGRESS:
                    if (mProgress < 40) {
                        ...
                        mProgress=0;
                        mHandler.sendEmptyMessageDelayed(REFRESH_PROGRESS,new Random().nextInt(10));
                        mLeafLoadingView.setProgress(mProgress);
                        mFanView.setAnimation(null);
                        Toast.makeText(LeafLoadingActivity.this, "动画置空", Toast.LENGTH_SHORT).show();
                        mFanView.setVisibility(View.INVISIBLE);
                        Toast.makeText(LeafLoadingActivity.this,"视图消失",Toast.LENGTH_SHORT).show();
                    }
                    break;
    ...
    private void initViews() {
        ...
        mMplitudeText.setText(getString(R.string.current_amplitude,
